                ...
                <div class="col-sm-4 col-lg-4 col-md-4">
                    <div class="thumbnail thumbnail-bg">
                        <ul class="hoverflip">
                          <li>
                            <figure>
                                <img src="images/country/country1.jpg" alt=""/>
                ...
                <div class="col-sm-4 col-lg-4 col-md-4">
                    <div class="thumbnail thumbnail-bg">
                        <ul class="hoverflip">
                          <li>
                            <figure>
                                <img src="images/country/country2.jpg" alt=""/>
                                    <figcaption class="caption">
                                        <h2>This Album has:</h2>
                                        <p>
                                            Song1: ...</br>
                ...
                <div class="col-sm-4 col-lg-4 col-md-4">
                    <div class="thumbnail thumbnail-bg">
                        <ul class="hoverflip">
                          <li>
                            <figure>
                                <img src="images/country/country3.jpg" alt=""/>
                                    <figcaption class="caption">
                                        <h2>This Album has:</h2>
                                        <p>
                                            Song1: ...</br>
                ...
                <div class="col-sm-4 col-lg-4 col-md-4">
                    <div class="thumbnail thumbnail-bg">
                        <ul class="hoverflip">
                          <li>
                            <figure>
                                <img src="images/country/country4.jpg" alt=""/>
                                    <figcaption class="caption">
                                        <h2>This Album has:</h2>
                                        <p>
                                            Song1: ...</br>
                ...
                <div class="col-sm-4 col-lg-4 col-md-4">
                    <div class="thumbnail thumbnail-bg">
                        <ul class="hoverflip">
                          <li>
                            <figure>
                                <img src="images/country/country5.jpg" alt=""/>
                                    <figcaption class="caption">
                                        <h2>This Album has:</h2>
                                        <p>
                                            Song1: ...</br>
