...
public class JunitTest {
	...
	public void  testAddOrderDetails() {
		...
		try{
			...
			Query query = session.createQuery("FROM ORDERDETAIL where EMAIL='" + email + "'");
        ...
        String emailTest = orderTest.getEmail();
	...
	public void  testGetOrderDetails() {
		...
		boolean test = orderDao.addOrderDetails(email, datetime, price, phonenumber, address);
		order = orderDao.getOrderDetails(phonenumber);
		
		try{
		
        
        String emailTest = order.getEmail();
	...
	public void  testAddUserDetails() {
		...
		String firstName = "DEFAULT_NO_FIRSTNAME_STRING_THIS_SHOULD_NEVER_BE_SAME_WITH_ANYONE";
		String lastName = "DEFAULT_NO_LASTNAME_STRING_THIS_SHOULD_NEVER_BE_SAME_WITH_ANYONE";
        ...
        String firstNameTest = userTest.getFirstName();
        String lastNameTest = userTest.getLastName();
       ...
       String addressTest = userTest.getAddress();
        ...
        assertThat(success,equalTo(true));
        assertThat(firstName,equalTo(firstNameTest));
        assertThat(lastName,equalTo(lastNameTest));
        assertThat(email,equalTo(emailTest));
	...
	public void  testgetUserDetails() {
		...
		boolean test = userDao.addUserDetails(firstName, lastName, password, email, phone, address);
		user = userDao.getUserDetails(email);
		
		try{
        
        String firstNameTest = user.getFirstName();
        String lastNameTest = user.getLastName();
