                ...
                <div class="col-sm-4 col-lg-4 col-md-4">
                    <div class="thumbnail thumbnail-bg">
                        <ul class="hoverflip">
                          <li>
                            <figure>
                                <img src="images/techno/techno1.jpg" alt=""/>
                ...
                <div class="col-sm-4 col-lg-4 col-md-4">
                    <div class="thumbnail thumbnail-bg">
                        <ul class="hoverflip">
                          <li>
                            <figure>
                                <img src="images/techno/techno2.jpg" alt=""/>
                                    <figcaption class="caption">
                                        <h2>This Album has:</h2>
                                        <p>
                                            Song1: ...</br>
                ...
                <div class="col-sm-4 col-lg-4 col-md-4">
                    <div class="thumbnail thumbnail-bg">
                        <ul class="hoverflip">
                          <li>
                            <figure>
                                <img src="images/techno/techno3.jpg" alt=""/>
                                    <figcaption class="caption">
                                        <h2>This Album has:</h2>
                                        <p>
                                            Song1: ...</br>
                ...
                <div class="col-sm-4 col-lg-4 col-md-4">
                    <div class="thumbnail thumbnail-bg">
                        <ul class="hoverflip">
                          <li>
                            <figure>
                                <img src="images/techno/techno4.jpg" alt=""/>
                                    <figcaption class="caption">
                                        <h2>This Album has:</h2>
                                        <p>
                                            Song1: ...</br>
                ...
                <div class="col-sm-4 col-lg-4 col-md-4">
                    <div class="thumbnail thumbnail-bg">
                        <ul class="hoverflip">
                          <li>
                            <figure>
                                <img src="images/techno/techno5.jpg" alt=""/>
                                    <figcaption class="caption">
                                        <h2>This Album has:</h2>
                                        <p>
                                            Song1: ...</br>
