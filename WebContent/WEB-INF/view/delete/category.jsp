                ...
                <div class="col-sm-4 col-lg-4 col-md-4">
                    <div class="thumbnail thumbnail-bg">
                        <ul class="hoverflip">
                          <li>
                            <figure>
                                <img src="images/pop/Album1.1.jpg" alt=""/>
                        ...
                        <div class="caption">
                            ...
                            <button class="myButton center">Add to Cart</button>
                        </div>
                        <div class="ratings">
                ...
                <div class="col-sm-4 col-lg-4 col-md-4">
                    <div class="thumbnail thumbnail-bg">
                        <ul class="hoverflip">
                          <li>
                            <figure>
                                <img src="images/pop/Album2.1.jpg" alt=""/>
                                    <figcaption class="caption">
                                        <h2>This Album has:</h2>
                                        <p>
                                            Song1: ...</br>
                ...
                <div class="col-sm-4 col-lg-4 col-md-4">
                    <div class="thumbnail thumbnail-bg">
                        <ul class="hoverflip">
                          <li>
                            <figure>
                                <img src="images/pop/Album3.1.jpg" alt=""/>
                                    <figcaption class="caption">
                                        <h2>This Album has:</h2>
                                        <p>
                                            Song1: ...</br>
                ...
                <div class="col-sm-4 col-lg-4 col-md-4">
                    <div class="thumbnail thumbnail-bg">
                        <ul class="hoverflip">
                          <li>
                            <figure>
                                <img src="images/pop/Album4.1.jpg" alt=""/>
                                    <figcaption class="caption">
                                        <h2>This Album has:</h2>
                                        <p>
                                            Song1: ...</br>
                ...
                <div class="col-sm-4 col-lg-4 col-md-4">
                    <div class="thumbnail thumbnail-bg">
                        <ul class="hoverflip">
                          <li>
                            <figure>
                                <img src="images/pop/Album5.1.jpg" alt=""/>
                                    <figcaption class="caption">
                                        <h2>This Album has:</h2>
                                        <p>
                                            Song1: ...</br>
                ...
                <div class="col-sm-4 col-lg-4 col-md-4">
                    <div class="thumbnail thumbnail-bg">
                        <ul class="hoverflip">
                          <li>
                            <figure>
                                <img src="images/pop/Album8.1.jpg" alt=""/>
                                    <figcaption class="caption">
                                        <h2>This Album has:</h2>
                                        <p>
                                            Song1: ...</br>
                ...
                <div class="col-sm-4 col-lg-4 col-md-4">
                    <div class="thumbnail thumbnail-bg">
                        <ul class="hoverflip">
                          <li>
                            <figure>
                                <img src="images/pop/Album6.1.jpg" alt=""/>
                                    <figcaption class="caption">
                                        <h2>This Album has:</h2>
                                        <p>
                                            Song1: ...</br>
                ...
                <div class="col-sm-4 col-lg-4 col-md-4">
                    <div class="thumbnail thumbnail-bg">
                        <ul class="hoverflip">
                          <li>
                            <figure>
                                <img src="images/pop/Album9.1.jpg" alt=""/>
                                    <figcaption class="caption">
                                        <h2>This Album has:</h2>
                                        <p>
                                            Song1: ...</br>
                ...
                <div class="col-sm-4 col-lg-4 col-md-4">
                    <div class="thumbnail thumbnail-bg">
                        <ul class="hoverflip">
                          <li>
                            <figure>
                                <img src="images/pop/Album11.1.jpg" alt=""/>
                                    <figcaption class="caption">
                                        <h2>This Album has:</h2>
                                        <p>
                                            Song1: ...</br>
