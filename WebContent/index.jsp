		...
		<div class="container-fluid">
			...
			<div>
				<ul class="nav navbar-nav">
					...
					<li><a href="/HibernateWebApp/category">Category</a></li>
					<li><a href="/HibernateWebApp/cart">Cart</a></li>
					<li><a href="/HibernateWebApp/about">About</a></li>
				</ul>
				<ul class="nav navbar-nav navbar-right">
					<li><a href="/HibernateWebApp/signup"><span
							class="glyphicon glyphicon-user"></span> Sign Up</a></li>
					<li><a href="/HibernateWebApp/login"><span
	...
	<div class="container-fluid">
		<div class="col-md-11">
			<div class="jumbotron jumbotron-bg1">
				...
				<p id="firstpar">
					Here you can select your favorite genre of music, browse the Albums
					and add them to your cart with a single click. <br /> Simply
					checkout your orders and enjoy the sound of music! <br />
				</p>
			</div>
		</div>
	</div>
	...
	<div class="container-fluid">
		<div class="col-md-3">
			...
			<div class="list-group">
				<a href="/HibernateWebApp/category-pop?category=pop"
					class="list-group-item list-group-item-bg">Pop</a> <a
					href="/HibernateWebApp/category-classic"
					class="list-group-item list-group-item-bg">Classic</a> <a
					href="/HibernateWebApp/category-rock"
					class="list-group-item list-group-item-bg">Rock</a> <a
					href="/HibernateWebApp/category-country"
					class="list-group-item list-group-item-bg">Country</a> <a
					href="/HibernateWebApp/category-rnb"
					class="list-group-item list-group-item-bg">RnB</a> <a
					href="/HibernateWebApp/category-techno"
					class="list-group-item list-group-item-bg">Techno</a>
			</div>
		</div>
