  ...
  <div class="container-fluid">
    ...
    <div>
      ...
      <ul class="nav navbar-nav navbar-right">
        <li><a href="/HibernateWebApp/signup"><span class="glyphicon glyphicon-user"></span> Sign Up</a></li>
        <li><a href="/HibernateWebApp/login"><span class="glyphicon glyphicon-log-in"></span> Login</a></li>
      </ul>
    </div>
  </div>
</nav>
    ...
    <div class="col-md-3">
    	<!--<p class="lead">Genres</p>-->
            <div class="list-group">
                <a href="/HibernateWebApp/category-pop" class="list-group-item list-group-item-bg">Pop</a>
                <a href="/HibernateWebApp/category-classic" class="list-group-item list-group-item-bg">Classic</a>
                <a href="/HibernateWebApp/category-rock" class="list-group-item list-group-item-bg">Rock</a>
                <a href="/HibernateWebApp/category-country" class="list-group-item list-group-item-bg">Country</a>
                <a href="/HibernateWebApp/category-rnb" class="list-group-item list-group-item-bg">RnB</a>
                <a href="/HibernateWebApp/category-techno" class="list-group-item list-group-item-bg">Techno</a> 
             </div>
    </div>
